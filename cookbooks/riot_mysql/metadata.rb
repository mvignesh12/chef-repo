...
version           "1.2.8"
recipe            "riot_mysql", "Includes the client recipe to configure a client"
recipe            "riot_mysql::client", "Installs packages required for mysql clients using run_action magic"
recipe            "riot_mysql::server", "Installs packages required for mysql servers w/o manual intervention"
recipe            "riot_mysql::server_ec2", "Performs EC2-specific mountpoint manipulation"
